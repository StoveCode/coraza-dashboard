<template>
  <div class="bg-gray-900 border border-gray-800 rounded-xl p-5">
    ...
    <div v-show="infoOpen" class="mb-4 bg-gray-800/60 border border-gray-700 rounded-lg p-3 text-xs text-gray-400 space-y-1">
      <p>Response rules inspect what your server sends back. CRS checks for:</p>
      <div class="pt-1 space-y-0.5">
        <p>• <span class="text-gray-300">SQL error messages</span> (Oracle, MySQL, DB2, …) — indicates successful injection</p>
        <p>• <span class="text-gray-300">PHP/Java/IIS stack traces</span> — reveals internal structure</p>
        <p>• <span class="text-gray-300">Directory listings</span> — exposes file structure</p>
